package com.example.gd12_pdf_c_10573
...
import com.example.gd12_pdf_c_10573.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.keqing_wangi)
